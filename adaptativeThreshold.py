...
if __name__ == '__main__':
    ...
    patha = "C:\\Users\\mdesimone\\Desktop\\Aaaa_a_Snake\\Tesseract\\2.jpeg"
    newpatha = "C:\\Users\\mdesimone\\Desktop\\Aaaa_a_Snake\\PythonWebProject\\2_bin.jpeg"
    pathapatha = patha
    output = adaptative_thresholding(patha, 10)

    imgname = ntpath.basename(patha)

    cv2.imwrite(os.path.splitext(imgname)[0] + '_bin' + os.path.splitext(imgname)[1], output)

    print(getTotal(pathapatha))
